...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig, FILE_NAME:str, TARGET_NAME:str):
        ...
        self.model_trainer_dir:str=os.path.join(
            training_pipeline_config.artifact_dir,self.file_name,training_pipeline.MODEL_TRAINER_DIR_NAME
        )
        self.trained_model_file_path:str=os.path.join(
            self.model_trainer_dir,training_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR, f"{self.target_name}_{training_pipeline.MODEL_FILE_NAME}"
        )
